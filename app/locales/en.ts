...
const en: LocaleType = {
  ...
  Chat: {
    ...
    InputActions: {
      ...
      ImageSizeAuto: "Automatic (follow prompt)",
      ImageSizePreset: "Resolution and aspect ratio",
      ImageSizeCustom: "Custom pixels",
      ImageAspectRatio: "Aspect ratio",
      ImageCustomRatio: "Custom ratio",
      ImageCustomPixels: "Width × height (pixels)",
      NotApplicable: "N/A",
    },
    Rename: "Rename Chat",
    Typing: "Typing…",
